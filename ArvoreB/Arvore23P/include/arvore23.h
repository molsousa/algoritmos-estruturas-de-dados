...
boolean eh_folha(arvore23);

// Funcao auxiliar para criar no23
// Pre-condicao: nenhuma
// Pos-condicao: retorna novo no
// Entrada: chave esquerda, chave direita, ponteiro pai, ponteiro esquerdo, ponteiro do meio, ponteiro direito, numero de chaves
arvore23 cria_no(int, int, arvore23, arvore23, arvore23, arvore23, int);
